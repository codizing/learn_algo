/* ==========================================================================
  ...
  en: {
    ...
    tab_courses: 'Courses', tab_td: 'TD (Exercises)', tab_tp: 'TP (Practical Labs)', tab_exams: 'Exams', tab_quiz: 'Quiz',
    type_course: 'Course', type_td: 'TD', type_tp: 'TP', type_exam: 'Exam',
    ...
    empty_tp: 'No TP worksheets have been added for this year yet.',
    ...
    course_marked_done: 'Marked as completed.', course_marked_undone: 'Removed from completed courses.',
    ...
    // About Page (EN)
    about_platform_eyebrow: 'About the Platform',
    about_title_prefix: 'About ',
    about_hero_quote: 'Built by a student, for students learning Algorithmique — because scattered PDFs in random group chats deserve better organization.',
    about_mission_eyebrow: 'The Mission',
    about_mission_title: 'One Organized Hub for CS Students',
    about_mission_p1: 'Learn Algo with MR exists to give Computer Science students from L1 to L3 one organized place for everything related to Algorithmique — courses, TDs, TPs, exams, quizzes, and more.',
    about_mission_p2: 'No more digging through scattered Facebook groups, Telegram channels, or old conversations every time exam season comes around.',
    about_mission_banner: 'Everything you need, organized in one place.',
    about_story_eyebrow: 'The Story',
    about_story_title: 'Born from Real Student Experience',
    about_story_p1: 'Learn Algo with MR was created by a Computer Science student who experienced firsthand how difficult it can be to find, organize, and keep track of Algorithmique resources.',
    about_story_p2: 'Between different PDFs, TDs shared across multiple groups, recorded lessons, and files saved somewhere you can never seem to find again, studying Algorithmique can quickly become more complicated than it needs to be.',
    about_story_p3: 'So I decided to build the platform I wished I had as a student — a simple, organized space where you can learn, practice, and keep track of your progress.',
    about_story_sharing: "And now, I'm sharing it with other students facing the same struggle.",
    about_inside_eyebrow: 'Features & Materials',
    about_inside_title: "What's Inside?",
    card_courses_title: 'Structured Courses',
    card_courses_desc: 'Learn chapter by chapter, from the basics to more advanced concepts.',
    card_td_title: 'TDs (Exercises)',
    card_td_desc: "Practice what you've learned with exercises and tutorial series.",
    card_tp_title: 'TPs (Practical Labs)',
    card_tp_desc: 'Hands-on coding, algorithm implementation and practical lab work.',
    card_exams_title: 'Past Exams',
    card_exams_desc: 'Prepare yourself with previous exams and their detailed corrections.',
    card_quizzes_title: 'Quizzes',
    card_quizzes_desc: 'Test your understanding and identify what you still need to improve.',
    card_progress_title: 'Progress Tracking',
    card_progress_desc: "Keep track of what you've completed and always know where you left off.",
    about_why_eyebrow: 'The Philosophy',
    about_why_title: 'Why Learn Algo with MR?',
    about_why_intro: "Because learning Algorithmique shouldn't start with:",
    about_why_problem: '"Wait... where did I save that PDF?"',
    about_why_solution_label: 'It should start with:',
    about_why_solution: '"Let\'s learn."',
    about_contact_eyebrow: 'Contact & Community',
    about_contact_title: 'Get in Touch',
    about_contact_li1: 'Have a suggestion?',
    about_contact_li2: 'Found a broken link?',
    about_contact_li3: 'Want to contribute a chapter, TD, TP, or useful resource?',
    about_contact_sub: "I'd love to hear from you.",
    // Subscription Gate (EN)
    sub_gate_title: 'Sign In to Access Courses',
    sub_gate_desc: 'Please sign in with your account to access full lecture slides, TD exercise sheets, past exams, and video lessons.',
    sub_gate_btn: 'Sign In to Unlock Courses',
    lock_btn_text: 'Sign in to access',
    // aliases
  ...
  fr: {
    ...
    tab_courses: 'Cours', tab_td: 'TD (Exercices)', tab_tp: 'TP (Travaux Pratiques)', tab_exams: 'Examens', tab_quiz: 'Quiz',
    type_course: 'Cours', type_td: 'TD', type_tp: 'TP', type_exam: 'Examen',
    ...
    empty_tp: 'Aucune fiche de TP ajoutée pour cette année pour le moment.',
    ...
    course_marked_done: 'Marqué comme terminé.', course_marked_undone: 'Retiré des cours terminés.',
    ...
    // About Page (FR)
    about_platform_eyebrow: 'À propos de la plateforme',
    about_title_prefix: 'À propos de ',
    about_hero_quote: 'Conçu par un étudiant, pour les étudiants qui apprennent l\'Algorithmique — parce que les PDF dispersés dans les groupes de discussion méritent une meilleure organisation.',
    about_mission_eyebrow: 'La Mission',
    about_mission_title: 'Un pôle unique et organisé pour les étudiants',
    about_mission_p1: 'Learn Algo with MR existe pour offrir aux étudiants en informatique de la L1 à la L3 un espace centralisé pour tout ce qui concerne l\'Algorithmique — cours, TD, TP, examens, quiz et plus encore.',
    about_mission_p2: 'Plus besoin de chercher dans des groupes Facebook dispersés, des canaux Telegram ou d\'anciennes conversations à chaque période d\'examens.',
    about_mission_banner: 'Tout ce dont vous avez besoin, organisé au même endroit.',
    about_story_eyebrow: 'L\'Histoire',
    about_story_title: 'Né d\'une réelle expérience étudiante',
    about_story_p1: 'Learn Algo with MR a été créé par un étudiant en informatique ayant constaté à quel point il est difficile de trouver, organiser et suivre les ressources d\'Algorithmique.',
    about_story_p2: 'Entre les différents PDF, les TD partagés sur plusieurs groupes, les cours enregistrés et les fichiers égarés, étudier l\'Algorithmique devenait vite bien trop compliqué.',
    about_story_p3: 'J\'ai donc décidé de construire la plateforme que j\'aurais aimé avoir en tant qu\'étudiant — un espace simple et structuré pour apprendre, s\'exercer et suivre sa progression.',
    about_story_sharing: "Et aujourd'hui, je la partage avec les autres étudiants confrontés aux mêmes défis.",
    about_inside_eyebrow: 'Ressources & Fonctionnalités',
    about_inside_title: 'Que trouve-t-on à l\'intérieur ?',
    card_courses_title: 'Cours Structurés',
    card_courses_desc: 'Apprenez chapitre par chapitre, des bases fondamentales jusqu\'aux concepts avancés.',
    card_td_title: 'TD (Exercices)',
    card_td_desc: 'Mettez en pratique vos acquis avec des exercices et des séries de TD.',
    card_tp_title: 'TP (Travaux Pratiques)',
    card_tp_desc: 'Programmation pratique, implémentation d\'algorithmes et ateliers en laboratoire.',
    card_exams_title: 'Annales d\'Examens',
    card_exams_desc: 'Préparez-vous avec d\'anciens examens et leurs corrections détaillées.',
    card_quizzes_title: 'Quiz',
    card_quizzes_desc: 'Testez vos connaissances et identifiez ce que vous devez encore améliorer.',
    card_progress_title: 'Suivi de Progression',
    card_progress_desc: 'Gardez une trace de ce que vous avez terminé et sachez toujours où vous en êtes.',
    about_why_eyebrow: 'La Philosophie',
    about_why_title: 'Pourquoi Learn Algo with MR ?',
    about_why_intro: 'Parce qu\'apprendre l\'Algorithmique ne devrait pas commencer par :',
    about_why_problem: '"Attends... où est-ce que j\'ai enregistré ce PDF ?"',
    about_why_solution_label: 'Cela devrait commencer par :',
    about_why_solution: '"Apprenons."',
    about_contact_eyebrow: 'Contact & Communauté',
    about_contact_title: 'Contactez-nous',
    about_contact_li1: 'Une suggestion ?',
    about_contact_li2: 'Un lien inaccessible ?',
    about_contact_li3: 'Envie de contribuer avec un chapitre, TD, TP ou document utile ?',
    about_contact_sub: 'Au plaisir d\'échanger avec vous.',
    // Subscription Gate (FR)
    sub_gate_title: 'Connexion requise pour accéder aux cours',
    sub_gate_desc: 'Veuillez vous connecter avec votre compte pour accéder à l\'intégralité des cours, fiches de TD, corrigés d\'examens et vidéos.',
    sub_gate_btn: 'Se connecter pour débloquer les cours',
    lock_btn_text: 'Connexion requise',
    // aliases
